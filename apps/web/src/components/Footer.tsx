...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: <GithubLogo width="20px" height="100%" />, href: "https://github.com/mirusausiliq" },
    { icon: <FacebookLogo width="20px" height="100%" />, href: "https://facebook.com/ketangalan" },
    { icon: <InstagramLogo width="20px" height="100%" />, href: "https://instagram.com/ketangalan" },
    { icon: <ThreadsLogo width="20px" height="100%" />, href: "https://threads.net/ketangalan" },
    { icon: <LuMail width="20px" height="100%" />, href: "mailto:mirusausiliq@gmail.com" }
  ];
